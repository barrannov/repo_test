...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/24 13:50:45 by abaranov          #+#    #+#              #
#    Updated: 2016/11/24 14:51:53 by abaranov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJECTS =	ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o\
			...
			ft_lstmap.o ft_amount_d.o full.o ft_count_l.o\
			ft_count_w.o\
...
SRC =	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c\
		...
		ft_lstmap.c ft_amount_d.c full.c ft_count_l.c\
		ft_count_w.c\
